...
{ 
	...
	mat4 Tinv = inverse(T); // Make inverse matrixes to T, R & S.
	mat4 Rinv = inverse(transpose(R)); // Make inverse matrixes to T, R & S.
	mat4 Sinv = inverse(S); // Make inverse matrixes to T, R & S.
